...
public class StudentAppHomePage {
    ...
    private static final String appPackage= PropertiesFileReader.getValue("studentAppPackage");
    private static final String appActivity= PropertiesFileReader.getValue("studentAppActivity");
    private static final String appiumUrl= PropertiesFileReader.getValue("appiumUrl");

    private static final By getStartedBtnLocator= By.id("com.itworx.winjigostudent:id/buttonSignIn");



    public StudentAppLoginPage openStudentKitApp() throws MalformedURLException {
        ...
        return new StudentAppLoginPage(driver);
    }
}
